...
if __name__ == "__main__":
	HEATMAP_PATH = "/home/cdeng/caffe-heatmap/models/heatmap-flic-fusion"
	netmodel   = os.path.join(HEATMAP_PATH, "deploy.prototxt") 
	print netmodel
	netweights = os.path.join(HEATMAP_PATH, "caffe-heatmap-flic.caffemodel")
	output = "heatmapzip"
	caffe_model_compress(netmodel, netweights, output, 8, 8)

	caffe_model_decompress(netmodel, "heatmap_xx.caffemodel", "heatmapzip.npz")
